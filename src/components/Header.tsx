...
import { Zap, Home, Briefcase, Wallet, Bell, Settings } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-4 items-center">
            ...
            <li><Link to="/settings" className="text-gray-600 hover:text-primary-500"><Settings size={20} /></Link></li>
          </ul>
        </nav>
      </div>
    </header>
